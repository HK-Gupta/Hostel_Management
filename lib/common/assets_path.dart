class ImagePaths {
  ...
  static const allIssues = "${basePath}all_issues.png";
  static const changeRequest = "${basePath}change_request.png";
...
class LottiePath {
  static const basePath = "assets/json/";
  static const home = "${basePath}home.json";
}