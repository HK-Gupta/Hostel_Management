...
class _AllIssuesScreenState extends State<AllIssuesScreen> {
  ...
  Future<void> resolveIssue(final issue) async {
    setState(() {
      isLoading = true;
    });
...
class IssueCard  extends StatelessWidget {
  ...
  final Future<void> Function(IssueModel issue) resolveIssue;
  const IssueCard ({super.key, required this.issue, required this.isLoading, required this.resolveIssue});
